...
<body>
    ...
    <form action="cliente.php" method="POST">
        <label for="nome" name="nome_cliente">Coloque seu nome:</label></br>
        <input type="text" name="nome_cliente" required></br></br>
        <label for="email" name="email_cliente">Coloque seu email:</label></br>
        ...
        <label for="telefone" name="telefone_cliente">Coloque seu telefone:</label></br>
        <input type="text" name="telefone_cliente" required></br></br>
        <input type="submit"  name="enviar_dados_cliente">

    </form>

    <a href="ver_solicitacoes.php">Ir para as solicitações</a>
